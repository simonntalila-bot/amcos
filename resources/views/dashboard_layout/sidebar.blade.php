...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
        ...
        <div class="sidebar-brand-text mx-3">AMCOS</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ request()->is('buttons') ? 'active' : '' }}" href="{{ url('buttons') }}">Buttons</a>
                <a class="collapse-item {{ request()->is('cards') ? 'active' : '' }}" href="{{ url('cards') }}">Cards</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item {{ request()->is('login') || request()->is('register') || request()->is('forgot-password') || request()->is('blank') ? 'active' : '' }}">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePages"
            aria-expanded="true" aria-controls="collapsePages">
            <i class="fas fa-fw fa-folder"></i>
            <span>Pages</span>
        </a>
        <div id="collapsePages" class="collapse {{ request()->is('login') || request()->is('register') || request()->is('forgot-password') || request()->is('blank') ? 'show' : '' }}"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ request()->is('forgot-password') ? 'active' : '' }}" href="{{ route('password.request') }}">Forgot Password</a>
                <div class="collapse-divider"></div>
                <h6 class="collapse-header">Other Pages:</h6>
                <a class="collapse-item {{ request()->is('404') ? 'active' : '' }}" href="{{ url('404') }}">404 Page</a>
                <a class="collapse-item {{ request()->is('blank') ? 'active' : '' }}" href="{{ url('blank') }}">Blank Page</a>
            </div>
        </div>
    </li>
